...
class chatFantasyViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBAction func sendPressed(_ sender: UIButton) {
        let messagesDB = Database.database().reference().child("fantasyMessages")
    ...
    func retrieveMessages() {
        let messageDB = Database.database().reference().child("fantasyMessages")
