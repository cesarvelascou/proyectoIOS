...
class chatWhateverViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    
    override func viewDidLoad() {
        super.viewDidLoad()
        navigationItem.title = "Whatever"
    ...
    @IBAction func sendPressed(_ sender: UIButton) {
        let messagesDB = Database.database().reference().child("whateverMessages")
    ...
    func retrieveMessages() {
        let messageDB = Database.database().reference().child("whateverMessages")
