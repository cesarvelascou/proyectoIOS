...
class chatHorrorViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    
    override func viewDidLoad() {
        super.viewDidLoad()
        navigationItem.title = "Horror"
    ...
    @IBAction func sendPressed(_ sender: Any) {
        let messagesDB = Database.database().reference().child("horrorMessages")
    ...
    func retrieveMessages() {
        let messageDB = Database.database().reference().child("horrorMessages")
